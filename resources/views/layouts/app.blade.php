        ...
        <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
            ...
            <div class="w-full flex items-stretch justify-end md:justify-between">
                ...
                <div class="hidden lg:flex justify-start items-stretch">
                    <a href="/panel/dashboard" class="inline-flex px-4 justify-center items-center text-sm font-semibold border border-transparent {{ request()->is('panel/dashboard') ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-800 hover:bg-gray-100' }}">Dashboard</a>
                    <a href="/panel/agendamentos" class="inline-flex px-4 justify-center items-center text-sm font-semibold border border-transparent {{ request()->is('panel/agendamentos') ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-800 hover:bg-gray-100' }}">Agendamentos</a>
                </div>

                {{-- Direita: Google Play + avatar --}}
    ...
    <div class="sticky top-[49px] inset-x-0 z-20 bg-white border-y px-4 sm:px-6 lg:hidden">
        <div class="flex items-center py-2">
            ...
            <ol class="ms-3 flex items-center whitespace-nowrap">
                ...
                <li class="text-sm font-semibold text-gray-800 truncate">@yield('title', 'Painel')</li>
            </ol>
        </div>
    </div>
