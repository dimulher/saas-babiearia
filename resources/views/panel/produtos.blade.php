...
<div class="bg-white rounded-xl border border-gray-200 p-6">
    <div class="flex items-center justify-between mb-5">
        <h1 class="text-lg font-semibold text-gray-800">Produtos</h1>
        <a href="/panel/produtos/adicionar" class="bg-gray-900 hover:bg-gray-800 text-white text-sm px-4 py-2 rounded-lg font-medium">ADICIONAR</a>
    </div>
    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="border-b border-gray-200">
                ...
                <th class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wide py-3 px-2">Estoque</th>
            </tr>
        </thead>
        <tbody>
            <tr><td colspan="3" class="py-12 text-center text-gray-400 text-sm">Nenhum resultado encontrado. Tente ampliar a sua pesquisa.</td></tr>
        </tbody>
    </table>
