...
<div class="space-y-6" x-data="{
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                <thead class="bg-gray-900/50 text-gray-500 uppercase text-[9px] font-bold tracking-widest">
                    <tr>
                        <th class="px-3 sm:px-6 py-4">Produto</th>
                        <th class="px-3 sm:px-6 py-4">Preço Venda</th>
                        <th class="px-3 sm:px-6 py-4 text-center">Estoque</th>
                ...
                <tbody class="divide-y divide-gray-800/50">
                    @forelse($produtos as $produto)
                        <tr class="hover:bg-gray-900/40 transition-colors group">
                            ...
                            <td class="px-3 sm:px-6 py-5 font-bold text-white">R$ {{ number_format($produto->preco_venda, 2, ',', '.') }}</td>
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto flex items-end sm:items-center justify-center p-0 sm:p-4">
        ...
        <div x-show="showModal"
             ...
             class="relative bg-[#111827] rounded-t-3xl sm:rounded-2xl shadow-2xl w-full sm:max-w-lg border border-gray-800 z-10 max-h-[90vh] overflow-y-auto">
