...
<div class="space-y-8 max-w-2xl mx-auto">
    ...
    <div class="bg-gray-900/50 bg-[#111827] border border-gray-800/50 rounded-3xl shadow-sm border border-gray-800 p-10 space-y-10 shadow-sm rounded-[32px]">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-8">
            <div class="w-32 h-32 bg-gray-800/50 rounded-[40px] flex items-center justify-center border-4 border-dashed border-gray-800 cursor-pointer hover:bg-green-900/30 hover:border-violet-200 transition-all group relative overflow-hidden">
                <i class="fa-solid fa-cloud-arrow-up text-3xl text-gray-200 group-hover:text-green-400 transition-colors"></i>
                <div class="absolute inset-0 bg-green-500/0 group-hover:bg-green-500/5 transition-all"></div>
            </div>
            <div class="text-center sm:text-left">
                ...
                <button class="mt-4 text-[10px] font-bold text-green-500 uppercase tracking-widest hover:text-green-800 flex items-center gap-2 transition-colors">
        ...
        <div class="border-t border-gray-800/50 pt-10 grid grid-cols-1 gap-8">
            <div class="space-y-2">
                ...
                <input type="text" placeholder="Ex: Glow Beauty & Style"
                    class="block w-full px-6 py-4 bg-gray-800/50 border-gray-800 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-green-500 focus:bg-gray-900/50 transition-all outline-none">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" maxlength="2" placeholder="SP"
                        class="block w-full px-6 py-4 bg-gray-800/50 border-gray-800 rounded-2xl text-sm font-bold text-center focus:ring-2 focus:ring-green-500 focus:bg-gray-900/50 transition-all outline-none uppercase">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <input type="text" placeholder="seu-negocio"
                        class="block w-full pl-12 pr-6 py-4 bg-gray-800/50 border-gray-800 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-green-500 focus:bg-gray-900/50 transition-all outline-none">
                </div>
            </div>
        </div>

        <div class="pt-8 border-t border-gray-800/50">
            <button class="w-full sm:w-auto bg-green-500 text-white px-12 py-4 rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:bg-green-600 transition-all shadow-xl shadow-green-900/20 active:scale-95 italic">
