...
<div class="space-y-10 max-w-6xl mx-auto">
    ...
    <div class="bg-gray-900/50 bg-[#111827] border border-gray-800/50 rounded-3xl shadow-sm border border-gray-800 p-8 flex flex-col sm:flex-row items-center justify-between gap-6 relative overflow-hidden shadow-sm">
        <div class="absolute top-0 right-0 w-40 h-40 bg-violet-900/30 rounded-full -mr-20 -mt-20 opacity-50"></div>
        <div class="relative z-10 text-center sm:text-left">
            <span class="inline-flex items-center px-4 py-1.5 rounded-full text-[9px] font-bold uppercase tracking-widest bg-violet-100 text-violet-600 mb-3 border border-violet-200/50">Status: Ativo</span>
            <h2 class="text-3xl font-bold text-white uppercase tracking-tighter leading-none italic">Plano <span class="text-violet-600">Free Experience</span></h2>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-900 bg-[#111827] border border-gray-800/50 rounded-3xl shadow-sm border-none p-8 space-y-8 flex flex-col relative shadow-2xl scale-105 z-10 overflow-hidden">
                <div class="absolute top-0 right-0 w-32 h-32 bg-violet-600 rounded-full -mr-16 -mt-16 opacity-30 blur-3xl"></div>
                <span class="absolute -top-3 left-1/2 -translate-x-1/2 bg-violet-600 text-white text-[9px] font-bold uppercase tracking-widest px-6 py-2 rounded-full shadow-lg">Mais Vendido</span>
                
                <div>
                    <h3 class="text-xs font-bold text-violet-400 uppercase tracking-widest">Business Elite</h3>
                    <div class="flex items-baseline gap-1 mt-4">
