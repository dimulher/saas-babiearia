...
<div class="space-y-6 max-w-2xl">
    ...
    <h1 class="text-2xl font-bold text-white">Configurações de Assinaturas</h1>

    <div class="bg-gray-900/50 rounded-2xl border border-gray-700 p-6 space-y-5">

        <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">Modelo de comissão padrão</label>
            <select class="w-full border border-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">Percentual de comissão padrão (%)</label>
            <input type="number" min="0" max="100" value="30" class="w-full border border-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">Periodicidade de pagamento padrão</label>
            <select class="w-full border border-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
