...
<body class="bg-gray-950 min-h-screen text-white">
    ...
    <div class="max-w-lg mx-auto px-4 py-6" x-data="booking()">
        ...
        <div class="flex items-center gap-2 mb-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Serviço', 'Profissional', 'Data e Hora', 'Confirmação']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center gap-2 flex-1">
                <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0"
                    :class="<?php echo e($i + 1); ?> <= etapa ? 'bg-indigo-600 text-white' : 'bg-gray-700 text-gray-400'">
                    <?php echo e($i + 1); ?>

                </div>
                <span class="text-xs hidden sm:block" :class="<?php echo e($i + 1); ?> <= etapa ? 'text-white' : 'text-gray-500'"><?php echo e($step); ?></span>
        ...
        <div x-show="etapa === 1" class="space-y-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $servicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button @click="servico = '<?php echo e($s['nome']); ?>'; etapa = 2"
                ...
                <div class="text-left">
                    <p class="font-semibold text-white group-hover:text-indigo-300"><?php echo e($s['nome']); ?></p>
                    <p class="text-sm text-gray-400 mt-0.5"><i class="fa-regular fa-clock text-xs mr-1"></i><?php echo e($s['tempo']); ?></p>
                </div>
                <div class="text-right">
                    <p class="font-bold text-white"><?php echo e($s['preco']); ?></p>
        ...
        <div x-show="etapa === 2" class="space-y-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Gabriel', 'Lucas', 'Rafael']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button @click="profissional = '<?php echo e($p); ?>'; etapa = 3"
                class="w-full flex items-center gap-4 p-4 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-indigo-500 rounded-2xl transition-all group">
                <div class="w-12 h-12 bg-indigo-700 rounded-xl flex items-center justify-center font-bold text-white text-lg">
                    <?php echo e(substr($p, 0, 1)); ?>

                </div>
                <div class="text-left">
                    <p class="font-semibold text-white"><?php echo e($p); ?></p>
        ...
        <div x-show="etapa === 3" class="space-y-4">
            ...
            <div>
                ...
                <input type="date" x-model="data" min="<?php echo e(now()->format('Y-m-d')); ?>"
            ...
            <div>
                ...
                <div class="grid grid-cols-4 gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['08:00','08:30','09:00','09:30','10:00','10:30','11:00','11:30','13:00','13:30','14:00','14:30','15:00','15:30','16:00','16:30']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button @click="hora = '<?php echo e($h); ?>'"
                        :class="hora === '<?php echo e($h); ?>' ? 'bg-indigo-600 border-indigo-500 text-white' : 'bg-gray-800 border-gray-700 text-gray-300 hover:border-indigo-500'"
    ...
    <script>
        function booking() {
            return {
                ...
                servico: '',
                profissional: '',
                data: '<?php echo e(now()->format("Y-m-d")); ?>',
                hora: '',
                nomeCliente: '',
                telefone: '',
                confirmar() {
...
<?php /**PATH C:\Users\dede\saas-agendamento-barbiearia2026\resources\views/booking/index.blade.php ENDPATH**/ ?>